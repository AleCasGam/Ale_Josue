<template>
  <section class="p-4">
    <div class="relative items-center w-full h-[90svh] p-4 flex flex-col gap-2 border border-primary rounded-md">
      ...
      <div class="relative text-xs w-full p-3 flex flex-col items-center gap-1 border border-primary rounded-md">
        ...
        <HeartIcon class="w-2 h-2 text-primary" />

        <p class="font-serif text-black text-center  leading-relaxed">
          {{ data.messages.texto6 }}
        </p>

        <BotonEnlace
          :href="data.mesaRegalos"
...
<script>
import { HeartIcon, GiftIcon } from '@heroicons/vue/24/solid'
...
export default {
  ...
  data() {
    return {
      data: weddingData,
      GiftIcon, // se pasa como prop al BotonEnlace
    };
  }
};
</script>
...
<style scoped>
.image-1 {
  background-image: url('../../assets/images/pictures/select-11.webp');
